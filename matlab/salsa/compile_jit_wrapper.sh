...
matlab -batch "setenv('NVCC_APPEND_FLAGS','-allow-unsupported-compiler'); mexcuda('-v','NVCCFLAGS=\$NVCCFLAGS -std=c++17','-lnvrtc','-lcuda','relu_bat_c_sparse_tf32_nvrtc_mex.cu')"
