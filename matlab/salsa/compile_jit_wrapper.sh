...
matlab -batch "setenv('NVCC_APPEND_FLAGS','-allow-unsupported-compiler'); mexcuda('-v','NVCCFLAGS=\$NVCCFLAGS -std=c++17','-lnvrtc','-lcuda','-lcublas','relu_bat_c_fused_nvrtc_mex.cu')"
