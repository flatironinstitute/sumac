...
#define D_f {D_f}
#define MFMA_FP32_STAGES {num_stages}
#define MFMA_FP32_KERNEL_NAME {kernel_name}
#define MFMA_FP32_PACK_KERNEL_NAME {pack_kernel_name}
"""
...
def get_relu_bat_c_kernel_mfma(
    BM: int,
    BN: int,
    M_TILES: int,
    D_f: int,
    ...
    pack_kernel_name = f"relu_bat_c_fp32_mfma_pack_d{D_f}"
...
@lru_cache(maxsize=None)
def get_relu_bat_c_pack_kernel_mfma(
    BM: int,
    BN: int,
    M_TILES: int,
    D_f: int,
...
def relu_bat_c_fp32_mfma_available(
    device=None,
    D: int | None = None,
) -> bool:
...
def relu_bat_c_fp32_mfma(
    ...
    pack_kernel = get_relu_bat_c_pack_kernel_mfma(
        BM,
        BN,
        M_TILES,
        D_f,
    ...
    kernel = get_relu_bat_c_kernel_mfma(
        BM,
        BN,
        M_TILES,
        D_f,
...
__all__ = [
    "get_relu_bat_c_kernel_mfma",
    "get_relu_bat_c_pack_kernel_mfma",
